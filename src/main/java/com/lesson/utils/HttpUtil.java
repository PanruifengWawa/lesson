...
//        String SigParameter = MD5Util.getMD5String(accountSid+token+timeString).toUpperCase();
//
//        String url = "https://app.cloopen.com:8883/2013-12-26/Accounts/"+accountSid+"/SMS/TemplateSMS";
//        sendPost(url,"sig="+SigParameter);
//
//        return null;
//    }
    @SuppressWarnings("unchecked")
	public boolean sendPhoneVerifyCode(String code,String phoneNum){
...
//        restAPI.setAccount("8a48b551512459880151339497b02f2b", "a2780e18732b43ba9b9974c824f8cf19");
        restAPI.setAccount("8aaf07085cb01a51015cc02f9e260371", "91e82296386c44d4a29d73f52500c13e");
...
//        restAPI.setAppId("8a48b551516c09cd0151801fbf31255a");
        restAPI.setAppId("8aaf07085cb01a51015cc02f9e630375");
        ...
        //*********************************************************************************************************************
        result = restAPI.sendTemplateSMS(phoneNum,"191339" ,new String[]{code,"5"});
