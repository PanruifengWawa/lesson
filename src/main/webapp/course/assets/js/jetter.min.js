...
(function(){
  ...
  HTMLElement.prototype.exist = function(){
    return true;
  }
  HTMLCollection.prototype.exist = NodeList.prototype.exist= function(){
    if(this.length>0){
      return true;
    }
    return false;
